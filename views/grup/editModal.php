      ...
      <form action="" method="POST">
        ...
        <input type="hidden" name="id" value="<?= $row["id"] ?>">
          ...
          <div class="form-group row">
            <label for="namaGrup" class="col-sm-3 col-form-label">Nama Grup:</label>
            <div class="col-sm-9">
          ...
          <!-- pilih admin -->
          <div class="form-group row">
            <label for="admin_id" class="col-sm-3 col-form-label">NI, Nama Pembimbing STMIK:</label>
            <div class="col-sm-9">
              <div class="input-group mb-3">
          ...
          <!-- pilih pembimbing -->
          <div class="form-group row">
            <label for="pembimbing_id" class="col-sm-3 col-form-label">NI, Nama Pembimbing:</label>
            <div class="col-sm-9">
              <div class="input-group mb-3">
